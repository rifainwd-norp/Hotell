    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-serif text-white mb-2 tracking-tight">Admin Login</h1>
          <p className="text-slate-400 font-sans">Secure access to hotel management</p>
        </div>
        ...
        <div className="mt-12 text-center">
          <Link href="/" className="text-slate-500 hover:text-white transition-colors text-sm font-sans">
            ← Return to Website
          </Link>
        </div>
      </motion.div>
